...
export class GLDisplayEGL {
    ...
    name: string
    parent: Gst.Object
    /* Fields of GstGLEGL.GLDisplayEGL */
...
export class GLMemoryEGLAllocator {
    ...
    name: string
    parent: Gst.Object
    /* Fields of GstGLEGL.GLMemoryEGLAllocator */
...
export class GLMemoryEGL {
    /* Fields of GstGLEGL.GLMemoryEGL */
...
export abstract class GLMemoryEGLAllocatorClass {
    /* Fields of GstGLEGL.GLMemoryEGLAllocatorClass */
    static name: string
}
}