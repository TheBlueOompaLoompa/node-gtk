...
export function glEnsureElementData(element: object | null, displayPtr: GLDisplay, otherContextPtr: GLContext): boolean
...
export function glHandleSetContext(element: Gst.Element, context: Gst.Context, display: GLDisplay, otherContext: GLContext): boolean
...
export function glQueryLocalGlContext(element: Gst.Element, direction: Gst.PadDirection, contextPtr: GLContext): boolean
...
export class GLBaseMemoryAllocator {
    ...
    name: string
    parent: Gst.Object
    /* Fields of GstGL.GLBaseMemoryAllocator */
...
export class GLBufferAllocator {
    ...
    name: string
    parent: Gst.Object
    /* Fields of GstGL.GLBufferAllocator */
    /* Fields of GstGL.GLBaseMemoryAllocator */
    /* Fields of Gst.Allocator */
    object: Gst.Object
    memType: string
...
export class GLColorConvert {
    ...
    name: string
    parent: Gst.Object
    /* Fields of GstGL.GLColorConvert */
    /* Fields of Gst.Object */
...
export class GLMemoryAllocator {
    ...
    name: string
    parent: Gst.Object
    /* Fields of GstGL.GLMemoryAllocator */
    /* Fields of GstGL.GLBaseMemoryAllocator */
    /* Fields of Gst.Allocator */
    object: Gst.Object
    memType: string
...
export class GLMemoryPBOAllocator {
    ...
    name: string
    parent: Gst.Object
    /* Fields of GstGL.GLMemoryPBOAllocator */
    /* Fields of GstGL.GLMemoryAllocator */
    /* Fields of GstGL.GLBaseMemoryAllocator */
    /* Fields of Gst.Allocator */
    object: Gst.Object
...
export class GLOverlayCompositor {
    ...
    name: string
    parent: Gst.Object
    /* Fields of GstGL.GLOverlayCompositor */
    /* Fields of Gst.Object */
    object: GObject.InitiallyUnowned
    lock: GLib.Mutex
    flags: number
...
export class GLRenderbufferAllocator {
    ...
    name: string
    parent: Gst.Object
    /* Fields of GstGL.GLRenderbufferAllocator */
    /* Fields of GstGL.GLBaseMemoryAllocator */
    /* Fields of Gst.Allocator */
    object: Gst.Object
    memType: string
...
export abstract class GLColorConvertClass {
    /* Fields of GstGL.GLColorConvertClass */
    static name: string
}
...
export abstract class GLFramebufferClass {
    /* Fields of GstGL.GLFramebufferClass */
    static name: string
}
...
export class GLQuery {
    ...
    unset(): void
    static name: string
    static localGlContext(element: Gst.Element, direction: Gst.PadDirection, contextPtr: GLContext): boolean
}
...
export abstract class GLSLStageClass {
    /* Fields of GstGL.GLSLStageClass */
    static name: string
}
...
export abstract class GLViewConvertClass {
    /* Fields of GstGL.GLViewConvertClass */
    static name: string
}
...
export abstract class GLWindowClass {
    ...
    queueResize: any
    controlsViewport: any
    hasOutputSurface: any
    static name: string
}
