...
export const WEBDAV_CLIPBOARD_FOLDER_PATH: string
...
export class Audio {
    /* Properties of SpiceClientGLib.Audio */
...
export class DisplayChannel {
    ...
    static changePreferredVideoCodecTypes(channel: Channel, codecs: number, ncodecs: number): boolean
...
export class MainChannel {
    ...
    updateDisplayMm(id: number, widthMm: number, heightMm: number, update: boolean): void
    /* Methods of SpiceClientGLib.Channel */
    connect(): boolean
    destroy(): void
    disconnect(reason: ChannelEvent): void
...
export class UsbDeviceManager {
    ...
    createSharedCdDevice(filename: string): boolean
    ...
    isDeviceSharedCd(device: UsbDevice): boolean
...
export abstract class ChannelClass {
    ...
    iterateRead: any
    channelReset: any
    channelSendMigrationHandshake: any
    static name: string
}
...
export abstract class DisplayChannelClass {
    ...
    parentClass: ChannelClass
    displayPrimaryCreate: any
    displayPrimaryDestroy: any
    displayInvalidate: any
    displayMark: any
    static name: string
}
