...
export class CheckerDialog {
    /* Properties of Gspell.CheckerDialog */
    ...
    connect(sigName: "notify::handle-menubar-accel", callback: (($obj: CheckerDialog, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::handle-menubar-accel", callback: (($obj: CheckerDialog, pspec: GObject.ParamSpec) => void)): number
...
export class NavigatorTextView {
    /* Properties of Gspell.NavigatorTextView */
...
export abstract class CheckerClass {
    ...
    wordAddedToPersonal: any
    wordAddedToSession: any
    sessionCleared: any
    padding: object[]
    static name: string
}
