...
export class Client {
    ...
    /* Fields of ECal.Client */
    /* Fields of EDataServer.Client */
    ...
    createObject(icalcomp: ICalGLib.Component, opflags: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    createObjectFinish(result: Gio.AsyncResult): [ /* returnType */ boolean, /* outUid */ string | null ]
    createObjectSync(icalcomp: ICalGLib.Component, opflags: number, cancellable?: Gio.Cancellable | null): [ /* returnType */ boolean, /* outUid */ string | null ]
    createObjects(icalcomps: ICalGLib.Component[], opflags: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    createObjectsFinish(result: Gio.AsyncResult): [ /* returnType */ boolean, /* outUids */ string[] | null ]
    createObjectsSync(icalcomps: ICalGLib.Component[], opflags: number, cancellable?: Gio.Cancellable | null): [ /* returnType */ boolean, /* outUids */ string[] | null ]
    discardAlarm(uid: string, rid: string, auid: string, opflags: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    discardAlarmFinish(result: Gio.AsyncResult): boolean
    discardAlarmSync(uid: string, rid: string, auid: string, opflags: number, cancellable?: Gio.Cancellable | null): boolean
    ...
    modifyObject(icalcomp: ICalGLib.Component, mod: ObjModType, opflags: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    modifyObjectFinish(result: Gio.AsyncResult): boolean
    modifyObjectSync(icalcomp: ICalGLib.Component, mod: ObjModType, opflags: number, cancellable?: Gio.Cancellable | null): boolean
    modifyObjects(icalcomps: ICalGLib.Component[], mod: ObjModType, opflags: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    modifyObjectsFinish(result: Gio.AsyncResult): boolean
    modifyObjectsSync(icalcomps: ICalGLib.Component[], mod: ObjModType, opflags: number, cancellable?: Gio.Cancellable | null): boolean
    receiveObjects(icalcomp: ICalGLib.Component, opflags: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    receiveObjectsFinish(result: Gio.AsyncResult): boolean
    receiveObjectsSync(icalcomp: ICalGLib.Component, opflags: number, cancellable?: Gio.Cancellable | null): boolean
    removeObject(uid: string, rid: string, mod: ObjModType, opflags: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    removeObjectFinish(result: Gio.AsyncResult): boolean
    removeObjectSync(uid: string, rid: string, mod: ObjModType, opflags: number, cancellable?: Gio.Cancellable | null): boolean
    removeObjects(ids: ComponentId[], mod: ObjModType, opflags: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    removeObjectsFinish(result: Gio.AsyncResult): boolean
    removeObjectsSync(ids: ComponentId[], mod: ObjModType, opflags: number, cancellable?: Gio.Cancellable | null): boolean
    sendObjects(icalcomp: ICalGLib.Component, opflags: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    sendObjectsFinish(result: Gio.AsyncResult): [ /* returnType */ boolean, /* outUsers */ string[], /* outModifiedIcalcomp */ ICalGLib.Component ]
    sendObjectsSync(icalcomp: ICalGLib.Component, opflags: number, cancellable?: Gio.Cancellable | null): [ /* returnType */ boolean, /* outUsers */ string[], /* outModifiedIcalcomp */ ICalGLib.Component ]
...
export class ClientView {
    /* Properties of ECal.ClientView */
    /* Fields of ECal.ClientView */
    /* Fields of GObject.Object */
    gTypeInstance: GObject.TypeInstance
...
export class ReminderWatcher {
    ...
    defaultZone: ICalGLib.Timezone
    timersEnabled: boolean
    /* Fields of ECal.ReminderWatcher */
    /* Fields of GObject.Object */
    gTypeInstance: GObject.TypeInstance
    ...
    connect(sigName: "format-time", callback: (($obj: ReminderWatcher, rd: object | null, itt: object | null, inoutBuffer: object | null, bufferSize: number) => void)): number
    connect_after(sigName: "format-time", callback: (($obj: ReminderWatcher, rd: object | null, itt: object | null, inoutBuffer: object | null, bufferSize: number) => void)): number
    emit(sigName: "format-time", rd: object | null, itt: object | null, inoutBuffer: object | null, bufferSize: number): void
...
export class ComponentAlarm {
    ...
    constructor()
    static new(): ComponentAlarm
    static newFromComponent(component: ICalGLib.Component): ComponentAlarm | null
}
...
export class ComponentAlarmTrigger {
    ...
    static newFromProperty(property: ICalGLib.Property): ComponentAlarmTrigger | null
...
export class ComponentAttendee {
    ...
    constructor()
    static new(): ComponentAttendee
    static newFromProperty(property: ICalGLib.Property): ComponentAttendee | null
...
export class ComponentOrganizer {
    ...
    constructor()
    static new(): ComponentOrganizer
    static newFromProperty(property: ICalGLib.Property): ComponentOrganizer | null
