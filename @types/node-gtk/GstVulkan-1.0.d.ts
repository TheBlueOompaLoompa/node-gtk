...
export function vulkanEnsureElementData(element: Gst.Element, displayPtr: VulkanDisplay, instancePtr: VulkanInstance): boolean
...
export function vulkanHandleSetContext(element: Gst.Element, context: Gst.Context, display: VulkanDisplay, instance: VulkanInstance): boolean
...
export class VulkanBufferMemoryAllocator {
    ...
    name: string
    parent: Gst.Object
    /* Fields of GstVulkan.VulkanBufferMemoryAllocator */
...
export class VulkanDevice {
    ...
    isLayerEnabled(name: string): boolean
    open(): boolean
    /* Methods of Gst.Object */
    addControlBinding(binding: Gst.ControlBinding): boolean
    defaultError(error: GLib.Error, debug?: string | null): void
    ...
    static runContextQuery(element: Gst.Element, device: VulkanDevice): boolean
    static $gtype: GObject.Type
}
...
export class VulkanDisplay {
    ...
    static runContextQuery(element: Gst.Element, display: VulkanDisplay): boolean
    static $gtype: GObject.Type
}
...
export class VulkanFenceCache {
    ...
    name: string
    parent: Gst.Object
    /* Fields of GstVulkan.VulkanFenceCache */
    /* Fields of GstVulkan.VulkanHandlePool */
    device: VulkanDevice
    outstanding: object[]
    available: object[]
...
export class VulkanImageMemoryAllocator {
    ...
    name: string
    parent: Gst.Object
    /* Fields of GstVulkan.VulkanImageMemoryAllocator */
    /* Fields of Gst.Allocator */
    object: Gst.Object
    memType: string
    memMap: Gst.MemoryMapFunction
...
export class VulkanInstance {
    /* Properties of GstVulkan.VulkanInstance */
    requestedApiMajor: number
    requestedApiMinor: number
    /* Properties of Gst.Object */
    name: string
    ...
    enableLayer(name: string): boolean
    fillInfo(): boolean
    getExtensionInfo(name: string): [ /* returnType */ boolean, /* specVersion */ number | null ]
    getLayerInfo(name: string): [ /* returnType */ boolean, /* description */ string | null, /* specVersion */ number | null, /* implementationVersion */ number | null ]
    getProcAddress(name: string): object | null
    getVersion(major: number, minor: number, patch: number): void
    isExtensionEnabled(name: string): boolean
    isLayerEnabled(name: string): boolean
    open(): boolean
    /* Methods of Gst.Object */
    ...
    on(sigName: "notify::requested-api-major", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "notify::requested-api-major", callback: (...args: any[]) => void): NodeJS.EventEmitter
    off(sigName: "notify::requested-api-major", callback: (...args: any[]) => void): NodeJS.EventEmitter
    ...
    on(sigName: "notify::requested-api-minor", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "notify::requested-api-minor", callback: (...args: any[]) => void): NodeJS.EventEmitter
    off(sigName: "notify::requested-api-minor", callback: (...args: any[]) => void): NodeJS.EventEmitter
    ...
    static runContextQuery(element: Gst.Element, instance: VulkanInstance): boolean
    static $gtype: GObject.Type
}
...
export class VulkanMemoryAllocator {
    ...
    name: string
    parent: Gst.Object
    /* Fields of GstVulkan.VulkanMemoryAllocator */
    /* Fields of Gst.Allocator */
    object: Gst.Object
    memType: string
    memMap: Gst.MemoryMapFunction
...
export class VulkanQueue {
    ...
    static runContextQuery(element: Gst.Element, queue: VulkanQueue): boolean
    static $gtype: GObject.Type
}
...
export class VulkanTrashFenceList {
    ...
    name: string
    parent: Gst.Object
    /* Fields of GstVulkan.VulkanTrashList */
    /* Fields of GstVulkan.VulkanHandlePool */
    device: VulkanDevice
    outstanding: object[]
    available: object[]
...
export class VulkanWindow {
    ...
    name: string
    parent: Gst.Object
    /* Fields of GstVulkan.VulkanWindow */
    /* Fields of Gst.Object */
    object: GObject.InitiallyUnowned
    lock: GLib.Mutex
    flags: number
...
export class VulkanCommandBuffer {
    ...
    /* Methods of GstVulkan.VulkanCommandBuffer */
    static name: string
...
export class VulkanDescriptorSet {
    ...
    /* Methods of GstVulkan.VulkanDescriptorSet */
    static name: string
...
export class VulkanHandle {
    ...
    static setContext(element: Gst.Element, context: Gst.Context, display: VulkanDisplay, instance: VulkanInstance): boolean
}
...
export class VulkanImageView {
    ...
    /* Methods of GstVulkan.VulkanImageView */
    static name: string
...
export class VulkanTrash {
    ...
    userData: object
    /* Methods of GstVulkan.VulkanTrash */
    static name: string
...
export abstract class VulkanWindowClass {
    ...
    open: any
    close: any
    getPresentationSupport: any
    setWindowHandle: any
    getSurfaceDimensions: any
    handleEvents: any
    static name: string
}
