...
export function base64DecodeStep(in_: any, len: number, out: any, state: number, save: number): number
export function base64EncodeClose(in_: any, breakLines: boolean, out: any, state: number, save: number): number
export function base64EncodeSimple(data: any, len: number): number
export function base64EncodeStep(in_: any, len: number, breakLines: boolean, out: any, state: number, save: number): number
...
export class Outfile {
    ...
    unref(): void
    watchClosure(closure: GObject.Closure): void
    /* Virtual methods of Gsf.Outfile */
...
export class OutfileMSOle {
    /* Properties of Gsf.OutfileMSOle */
    /* Properties of Gsf.Output */
    container: Outfile
    readonly isClosed: boolean
    name: string
...
export class OutfileOpenPkg {
    /* Properties of Gsf.OutfileOpenPkg */
    /* Properties of Gsf.Output */
    container: Outfile
    readonly isClosed: boolean
    name: string
...
export class XMLInDoc {
    ...
    static name: string
    static new(nodes: XMLInNode[], ns: XMLInNS[]): XMLInDoc | null
