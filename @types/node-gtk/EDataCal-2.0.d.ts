...
export class CalBackend {
    ...
    /* Fields of EDataCal.CalBackend */
    /* Fields of EBackend.Backend */
    ...
    createObjects(calobjs: string, opflags: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    createObjectsFinish(result: Gio.AsyncResult, outUids: GLib.Queue): boolean
    createObjectsSync(calobjs: string, opflags: number, outUids: GLib.Queue, cancellable?: Gio.Cancellable | null): boolean
    discardAlarm(uid: string, rid: string, alarmUid: string, opflags: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    discardAlarmFinish(result: Gio.AsyncResult): boolean
    discardAlarmSync(uid: string, rid: string, alarmUid: string, opflags: number, cancellable?: Gio.Cancellable | null): boolean
    dupCacheDir(): string
    foreachView(): boolean
    ...
    modifyObjects(calobjs: string, mod: ECal.ObjModType, opflags: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    modifyObjectsFinish(result: Gio.AsyncResult): boolean
    modifyObjectsSync(calobjs: string, mod: ECal.ObjModType, opflags: number, cancellable?: Gio.Cancellable | null): boolean
    ...
    receiveObjects(calobj: string, opflags: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    receiveObjectsFinish(result: Gio.AsyncResult): boolean
    receiveObjectsSync(calobj: string, opflags: number, cancellable?: Gio.Cancellable | null): boolean
    refDataCal(): DataCal
    ...
    removeObjects(componentIds: ECal.ComponentId[], mod: ECal.ObjModType, opflags: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    removeObjectsFinish(result: Gio.AsyncResult): boolean
    removeObjectsSync(componentIds: ECal.ComponentId[], mod: ECal.ObjModType, opflags: number, cancellable?: Gio.Cancellable | null): boolean
    ...
    sendObjects(calobj: string, opflags: number, cancellable?: Gio.Cancellable | null, callback?: Gio.AsyncReadyCallback | null): void
    sendObjectsFinish(result: Gio.AsyncResult, outUsers: GLib.Queue): string
    sendObjectsSync(calobj: string, opflags: number, outUsers: GLib.Queue, cancellable?: Gio.Cancellable | null): string
    ...
    vfuncImplDiscardAlarm?(cal: DataCal, opid: number, cancellable: Gio.Cancellable | null, uid: string, rid: string, auid: string, opflags: number): void
    ...
    vfuncImplReceiveObjects?(cal: DataCal, opid: number, cancellable: Gio.Cancellable | null, calobj: string, opflags: number): void
    vfuncImplRefresh?(cal: DataCal, opid: number, cancellable?: Gio.Cancellable | null): void
    vfuncImplSendObjects?(cal: DataCal, opid: number, cancellable: Gio.Cancellable | null, calobj: string, opflags: number): void
...
export class CalBackendFactory {
    ...
    /* Fields of EDataCal.CalBackendFactory */
    /* Fields of EBackend.BackendFactory */
...
export class CalBackendSExp {
    /* Fields of EDataCal.CalBackendSExp */
    /* Fields of GObject.Object */
    gTypeInstance: GObject.TypeInstance
...
export class CalBackendSync {
    ...
    online: boolean
    readonly userPrompter: EBackend.UserPrompter
    /* Fields of EDataCal.CalBackendSync */
    /* Fields of EDataCal.CalBackend */
    /* Fields of EBackend.Backend */
    /* Fields of GObject.Object */
    gTypeInstance: GObject.TypeInstance
    ...
    createObjects(cal: DataCal, cancellable: Gio.Cancellable | null, calobjs: string[], opflags: number): [ /* uids */ string[], /* newComponents */ ECal.Component[] ]
    discardAlarm(cal: DataCal, cancellable: Gio.Cancellable | null, uid: string, rid: string, auid: string, opflags: number): void
    ...
    modifyObjects(cal: DataCal, cancellable: Gio.Cancellable | null, calobjs: string[], mod: ECal.ObjModType, opflags: number): [ /* oldComponents */ ECal.Component[], /* newComponents */ ECal.Component[] ]
    open(cal: DataCal, cancellable?: Gio.Cancellable | null): void
    receiveObjects(cal: DataCal, cancellable: Gio.Cancellable | null, calobj: string, opflags: number): void
    refresh(cal: DataCal, cancellable?: Gio.Cancellable | null): void
    removeObjects(cal: DataCal, cancellable: Gio.Cancellable | null, ids: ECal.ComponentId[], mod: ECal.ObjModType, opflags: number): [ /* oldComponents */ ECal.Component[], /* newComponents */ ECal.Component[] ]
    sendObjects(cal: DataCal, cancellable: Gio.Cancellable | null, calobj: string, opflags: number, users: string[]): /* modifiedCalobj */ string
    /* Methods of EDataCal.CalBackend */
    addTimezoneFinish(result: Gio.AsyncResult): boolean
    addTimezoneSync(tzobject: string, cancellable?: Gio.Cancellable | null): boolean
    addView(view: DataCalView): void
    ...
    vfuncDiscardAlarmSync?(cal: DataCal, cancellable: Gio.Cancellable | null, uid: string, rid: string, auid: string, opflags: number): void
    ...
    vfuncReceiveObjectsSync?(cal: DataCal, cancellable: Gio.Cancellable | null, calobj: string, opflags: number): void
...
export class CalCache {
    /* Fields of EDataCal.CalCache */
    /* Fields of EBackend.Cache */
    /* Fields of GObject.Object */
    gTypeInstance: GObject.TypeInstance
    ...
    copyMissingToColumnValues(columnNames: string[], columnValues: string[], otherColumns: EBackend.CacheColumnValues): void
    ...
    static new(filename: string, cancellable?: Gio.Cancellable | null): CalCache | null
...
export class CalMetaBackend {
    ...
    online: boolean
    readonly userPrompter: EBackend.UserPrompter
    /* Fields of EDataCal.CalMetaBackend */
    /* Fields of EDataCal.CalBackendSync */
    /* Fields of EDataCal.CalBackend */
    /* Fields of EBackend.Backend */
    /* Fields of GObject.Object */
    ...
    refCache(): CalCache
    refreshSync(cancellable?: Gio.Cancellable | null): boolean
    removeComponentSync(conflictResolution: EDataServer.ConflictResolution, uid: string, extra: string | null, object: string | null, opflags: number, cancellable?: Gio.Cancellable | null): boolean
    requiresReconnect(): boolean
    saveComponentSync(overwriteExisting: boolean, conflictResolution: EDataServer.ConflictResolution, instances: ECal.Component[], extra: string | null, opflags: number, cancellable?: Gio.Cancellable | null): [ /* returnType */ boolean, /* outNewUid */ string, /* outNewExtra */ string ]
    ...
    splitChangesSync(objects: CalMetaBackendInfo[], cancellable?: Gio.Cancellable | null): [ /* returnType */ boolean, /* outCreatedObjects */ CalMetaBackendInfo[], /* outModifiedObjects */ CalMetaBackendInfo[], /* outRemovedObjects */ CalMetaBackendInfo[] | null ]
    ...
    vfuncRemoveComponentSync?(conflictResolution: EDataServer.ConflictResolution, uid: string, extra: string | null, object: string | null, opflags: number, cancellable?: Gio.Cancellable | null): boolean
    vfuncRequiresReconnect?(): boolean
    vfuncSaveComponentSync?(overwriteExisting: boolean, conflictResolution: EDataServer.ConflictResolution, instances: ECal.Component[], extra: string | null, opflags: number, cancellable?: Gio.Cancellable | null): [ /* returnType */ boolean, /* outNewUid */ string, /* outNewExtra */ string ]
...
export class DataCal {
    /* Properties of EDataCal.DataCal */
    ...
    static new(backend: CalBackend, connection: Gio.DBusConnection, objectPath: string): DataCal | null
    static $gtype: GObject.Type
}
...
export class DataCalFactory {
    ...
    /* Fields of EBackend.DataFactory */
    /* Fields of EBackend.DBusServer */
    /* Fields of GObject.Object */
    gTypeInstance: GObject.TypeInstance
...
export class DataCalView {
    /* Properties of EDataCal.DataCalView */
    ...
    static new(backend: object | null, sexp: object | null, connection: Gio.DBusConnection, objectPath: string): DataCalView | null
    static $gtype: GObject.Type
}
export interface IntervalTree_ConstructProps extends GObject.Object_ConstructProps {
}
export class IntervalTree {
    /* Fields of EDataCal.IntervalTree */
    /* Fields of GObject.Object */
    gTypeInstance: GObject.TypeInstance
...
export class SubprocessCalFactory {
    ...
    /* Fields of EBackend.SubprocessFactory */
    /* Fields of GObject.Object */
    gTypeInstance: GObject.TypeInstance
...
export abstract class CalBackendSExpClass {
    /* Fields of EDataCal.CalBackendSExpClass */
    static name: string
}
...
export abstract class IntervalTreeClass {
    /* Fields of EDataCal.IntervalTreeClass */
    static name: string
}
