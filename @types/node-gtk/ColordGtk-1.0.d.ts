...
export class SampleWindow {
    ...
    connect(sigName: "notify::handle-menubar-accel", callback: (($obj: SampleWindow, pspec: GObject.ParamSpec) => void)): number
    connect_after(sigName: "notify::handle-menubar-accel", callback: (($obj: SampleWindow, pspec: GObject.ParamSpec) => void)): number
