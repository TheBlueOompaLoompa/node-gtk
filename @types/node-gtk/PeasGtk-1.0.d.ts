...
export class PluginManager {
    /* Properties of PeasGtk.PluginManager */
...
export class PluginManagerView {
    ...
    /* Fields of PeasGtk.PluginManagerView */
    ...
    vfuncPopulatePopup?(menu: any): void
    ...
    connect(sigName: "populate-popup", callback: (($obj: PluginManagerView, menu: any) => void)): number
    connect_after(sigName: "populate-popup", callback: (($obj: PluginManagerView, menu: any) => void)): number
    emit(sigName: "populate-popup", menu: any): void
