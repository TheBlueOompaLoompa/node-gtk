...
export class CallEvent {
    /* Properties of TelepathyLogger.CallEvent */
...
export class Entity {
    /* Properties of TelepathyLogger.Entity */
...
export class LogWalker {
    /* Properties of TelepathyLogger.LogWalker */
...
export class TextEvent {
    /* Properties of TelepathyLogger.TextEvent */
    /* Properties of TelepathyLogger.Event */
    readonly accountPath: string
    /* Fields of GObject.Object */
    gTypeInstance: GObject.TypeInstance
...
export abstract class LogWalkerClass {
    /* Fields of TelepathyLogger.LogWalkerClass */
    static name: string
}
