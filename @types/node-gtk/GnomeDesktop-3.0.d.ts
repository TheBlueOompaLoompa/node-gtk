...
export class BG {
    ...
    createFrameThumbnail(factory: DesktopThumbnailFactory, screen: any, destWidth: number, destHeight: number, frameNum: number): GdkPixbuf.Pixbuf
    createSurface(window: any, width: number, height: number): cairo.Surface
    createThumbnail(factory: DesktopThumbnailFactory, screen: any, destWidth: number, destHeight: number): GdkPixbuf.Pixbuf
...
export class BGCrossfade {
    /* Properties of GnomeDesktop.BGCrossfade */
...
export class RRConfig {
    /* Properties of GnomeDesktop.RRConfig */
...
export class RRScreen {
    ...
    static new(screen: any): RRScreen
    static newFinish(result: Gio.AsyncResult): RRScreen
    static newAsync(screen: any, callback?: Gio.AsyncReadyCallback | null): void
    static $gtype: GObject.Type
}
