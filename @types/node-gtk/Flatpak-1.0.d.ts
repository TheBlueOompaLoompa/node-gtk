...
export class BundleRef {
    /* Properties of Flatpak.BundleRef */
    /* Properties of Flatpak.Ref */
...
export class Installation {
    ...
    listPinnedRefs(arch?: string | null, cancellable?: Gio.Cancellable | null): InstalledRef[]
    ...
    listUnusedRefsWithOptions(arch?: string | null, metadataInjection?: GLib.HashTable | null, options?: GLib.Variant | null, cancellable?: Gio.Cancellable | null): InstalledRef[]
...
export class RelatedRef {
    /* Properties of Flatpak.RelatedRef */
    /* Properties of Flatpak.Ref */
...
export class RemoteRef {
    /* Properties of Flatpak.RemoteRef */
    /* Properties of Flatpak.Ref */
...
export class Transaction {
    /* Properties of Flatpak.Transaction */
    ...
    getIncludeUnusedUninstallOps(): boolean
    ...
    setDisableAutoPin(disablePin: boolean): void
    ...
    setIncludeUnusedUninstallOps(includeUnusedUninstallOps: boolean): void
    ...
    connect(sigName: "operation-done", callback: (($obj: Transaction, operation: TransactionOperation, commit: string | null, result: TransactionResult) => void)): number
    connect_after(sigName: "operation-done", callback: (($obj: Transaction, operation: TransactionOperation, commit: string | null, result: TransactionResult) => void)): number
    emit(sigName: "operation-done", operation: TransactionOperation, commit: string | null, result: TransactionResult): void
    ...
    connect(sigName: "ready-pre-auth", callback: (($obj: Transaction) => boolean)): number
    connect_after(sigName: "ready-pre-auth", callback: (($obj: Transaction) => boolean)): number
    emit(sigName: "ready-pre-auth"): void
    on(sigName: "ready-pre-auth", callback: (...args: any[]) => void): NodeJS.EventEmitter
    once(sigName: "ready-pre-auth", callback: (...args: any[]) => void): NodeJS.EventEmitter
    off(sigName: "ready-pre-auth", callback: (...args: any[]) => void): NodeJS.EventEmitter
...
export abstract class TransactionClass {
    ...
    operationDone: any
    operationError: any
    chooseRemoteForRef: any
    endOfLifed: any
    ready: any
    addNewRemote: any
    run: any
    endOfLifedWithRebase: any
    webflowStart: any
    webflowDone: any
    basicAuthStart: any
    installAuthenticator: any
    readyPreAuth: any
    padding: object[]
    static name: string
}
