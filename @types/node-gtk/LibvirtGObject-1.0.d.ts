...
export function initObject(argv?: string[] | null): void
export function initObjectCheck(argv?: string[] | null): boolean
...
export class Connection {
    /* Properties of LibvirtGObject.Connection */
...
export class DomainDevice {
    /* Properties of LibvirtGObject.DomainDevice */
...
export class DomainSnapshot {
    /* Properties of LibvirtGObject.DomainSnapshot */
...
export class Interface {
    /* Properties of LibvirtGObject.Interface */
...
export class Network {
    /* Properties of LibvirtGObject.Network */
...
export class NetworkDHCPLease {
    /* Properties of LibvirtGObject.NetworkDHCPLease */
...
export class NetworkFilter {
    /* Properties of LibvirtGObject.NetworkFilter */
...
export class NodeDevice {
    /* Properties of LibvirtGObject.NodeDevice */
...
export class Secret {
    /* Properties of LibvirtGObject.Secret */
...
export class StoragePool {
    /* Properties of LibvirtGObject.StoragePool */
...
export class StorageVol {
    /* Properties of LibvirtGObject.StorageVol */
...
export class Stream {
    /* Properties of LibvirtGObject.Stream */
