...
export function typeToFilterString(type: number): string
...
export class Chooser {
    ...
    /* Fields of GnomeBluetooth.Chooser */
    /* Fields of Gtk.Box */
...
export class SettingsWidget {
    ...
    /* Properties of Gtk.Orientable */
    orientation: Gtk.Orientation
    /* Fields of GnomeBluetooth.SettingsWidget */
    /* Fields of Gtk.Box */
    parentInstance: Gtk.Widget
    /* Fields of Gtk.Widget */
    /* Fields of GObject.InitiallyUnowned */
...
export abstract class ChooserClass {
    ...
    selectedDeviceChanged: any
    selectedDeviceActivated: any
    static name: string
}
