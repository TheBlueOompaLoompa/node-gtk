...
export function otTagsFromScriptAndLanguage(script: script_t, language: language_t, scriptCount: number, languageCount: number): [ /* scriptTags */ tag_t | null, /* languageTags */ tag_t | null ]
