...
export function callableInfoIterateReturnAttributes(info: CallableInfo, iterator: AttributeIter): [ /* returnType */ boolean, /* name */ string, /* value */ string ]
...
export class Repository {
    /* Fields of GIRepository.Repository */
...
export class BaseInfo {
    /* Fields of GIRepository.BaseInfo */
