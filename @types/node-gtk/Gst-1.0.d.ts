...
export function miniObjectReplace(olddata?: MiniObject | null, newdata?: MiniObject | null): boolean
export function miniObjectTake(olddata: MiniObject, newdata: MiniObject): boolean
...
export function structureTake(oldstrPtr?: Structure | null, newstr?: Structure | null): boolean
...
export class BufferPool {
    ...
    vfuncAllocBuffer?(buffer: Buffer, params: BufferPoolAcquireParams): FlowReturn
...
export class ControlBinding {
    /* Properties of Gst.ControlBinding */
    /* Properties of Gst.Object */
    name: string
    parent: Object
...
export class Device {
    /* Properties of Gst.Device */
    /* Properties of Gst.Object */
    name: string
    parent: Object
    /* Fields of Gst.Device */
    /* Fields of Gst.Object */
    object: GObject.InitiallyUnowned
    lock: GLib.Mutex
    flags: number
...
export class PadTemplate {
    ...
    static new(nameTemplate: string, direction: PadDirection, presence: PadPresence, caps: Caps): PadTemplate | null
    static newFromStaticPadTemplateWithGtype(padTemplate: StaticPadTemplate, padType: GObject.Type): PadTemplate | null
    static newWithGtype(nameTemplate: string, direction: PadDirection, presence: PadPresence, caps: Caps, padType: GObject.Type): PadTemplate | null
    static $gtype: GObject.Type
}
...
export class StreamCollection {
    ...
    name: string
    parent: Object
    /* Fields of Gst.StreamCollection */
    /* Fields of Gst.Object */
    object: GObject.InitiallyUnowned
    lock: GLib.Mutex
    flags: number
...
export abstract class BinClass {
    ...
    handleMessage: any
    doLatency: any
    deepElementAdded: any
    deepElementRemoved: any
    static name: string
}
...
export class DateTime {
    ...
    static newFromUnixEpochLocalTime(secs: number): DateTime | null
    static newFromUnixEpochLocalTimeUsecs(usecs: number): DateTime | null
    static newFromUnixEpochUtc(secs: number): DateTime | null
    static newFromUnixEpochUtcUsecs(usecs: number): DateTime | null
    ...
    static newY(year: number): DateTime | null
    static newYm(year: number, month: number): DateTime | null
    static newYmd(year: number, month: number, day: number): DateTime | null
}
export class DebugCategory {
    /* Fields of Gst.DebugCategory */
...
export abstract class ElementClass {
    ...
    addStaticMetadata(key: string, value: string): void
    addStaticPadTemplate(staticTempl: StaticPadTemplate): void
    addStaticPadTemplateWithGtype(staticTempl: StaticPadTemplate, padType: GObject.Type): void
    getMetadata(key: string): string
    getPadTemplate(name: string): PadTemplate | null
    getPadTemplateList(): PadTemplate[]
    setMetadata(longname: string, classification: string, description: string, author: string): void
...
export class Event {
    ...
    static newCaps(caps: Caps): Event | null
    static newCustom(type: EventType, structure: Structure): Event | null
    static newEos(): Event
    ...
    static newQos(type: QOSType, proportion: number, diff: ClockTimeDiff, timestamp: ClockTime): Event | null
    static newReconfigure(): Event
    static newSeek(rate: number, format: Format, flags: SeekFlags, startType: SeekType, start: number, stopType: SeekType, stop: number): Event | null
    static newSegment(segment: Segment): Event | null
    ...
    static newStep(format: Format, amount: number, rate: number, flush: boolean, intermediate: boolean): Event | null
...
export class Memory {
    ...
    unmap(info: MapInfo): void
    static name: string
    static newWrapped(flags: MemoryFlags, data: any, maxsize: number, offset: number, notify?: GLib.DestroyNotify | null): Memory | null
}
export class Message {
    ...
    writableStructure(): Structure
    static name: string
    static newApplication(src: Object | null, structure: Structure): Message | null
    static newAsyncDone(src: Object | null, runningTime: ClockTime): Message
    static newAsyncStart(src?: Object | null): Message
    static newBuffering(src: Object | null, percent: number): Message | null
    ...
    static newErrorWithDetails(src: Object | null, error: GLib.Error, debug: string, details?: Structure | null): Message | null
    ...
    static newInfoWithDetails(src: Object | null, error: GLib.Error, debug: string, details?: Structure | null): Message | null
    ...
    static newProgress(src: Object, type: ProgressType, code: string, text: string): Message | null
    ...
    static newWarningWithDetails(src: Object | null, error: GLib.Error, debug: string, details?: Structure | null): Message | null
}
export class Meta {
    /* Fields of Gst.Meta */
    flags: MetaFlags
...
export class Query {
    ...
    static newCustom(type: QueryType, structure?: Structure | null): Query | null
...
export class Structure {
    ...
    static newFromString(string: string): Structure | null
    static newIdEmpty(quark: GLib.Quark): Structure
    static take(oldstrPtr?: Structure | null, newstr?: Structure | null): boolean
}
...
export class TagList {
    ...
    static newFromString(str: string): TagList | null
